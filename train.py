...
def train_model(X_train, y_train, model_type):
    if model_type == 'random_forest':  # 随机树
        param_grid = {
...
if __name__ == "__main__":
    ...
    joblib.dump(le, 'weight/hand/label_encoder.pkl')
    ...
    for model_type, name in models.items():
        ...
        t = end - start
        print("训练时间：%dmin%.3fs" % (t // 60, t - 60 * (t // 60)))

    if best_model is not None:
        joblib.dump(best_model, 'weight/hand/best_model.pkl')
